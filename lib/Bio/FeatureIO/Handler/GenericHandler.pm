package Bio::FeatureIO::Handler::GenericHandler;
...
Bio::FeatureIO::Handler::GenericHandler.pm - <One-line description of module's
purpose>

=head1 VERSION

This documentation refers to Bio::FeatureIO::Handler::GenericHandler.pm version
Bio::Root::Root.

=head1 SYNOPSIS

   use Bio::FeatureIO::Handler::GenericHandler.pm;
